...
parser.add_argument('bam', help='Unaligned PacBio subreads BAM file')
parser.add_argument('--adapter-len', type=int, default=45, help='Expected SMRTbell adapter length')
parser.add_argument('--subread-len', type=int, default=98, help='Expected insert length')
parser.add_argument('--smin', type=float, default=0.75, help='Maximum allowed subread length')
parser.add_argument('--smax', type=float, default=1.25, help='Minimum allowed subread length')
parser.add_argument('--amin', type=float, default=0.75, help='Maximum allowed adapter length')
parser.add_argument('--amax', type=float, default=1.25, help='Minimum allowed adapter length')
parser.add_argument('--outfile0', default='subreads.0.txt')
parser.add_argument('--outfile1', default='subreads.1.txt')
